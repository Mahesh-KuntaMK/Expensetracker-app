...
async function expense(event){
  ...
  // console.log('expense.js')
   ...
   console.log(token,'addtoken')
     ...
     const expense=await axios.post('http://54.89.10.176:3000/expense/addexpense',product,{headers:{"Authorization":token}})
...
window.addEventListener('DOMContentLoaded',async ()=>{
    try{
       ...
       const product=await axios.get(`http://54.89.10.176:3000/expense/getexpense?page=${page}&noofrows=${noofrows}`,{headers:{"Authorization":token}})
...
function getproducts(page){
  ...
  axios.get(`http://54.89.10.176:3000/expense/getexpense?page=${page}`,{headers:{"Authorization":token}})
  .then(response=>{
...
async function deleteProduct(id){
   try{
     //console.log(id);
     const token=localStorage.getItem('token');
   const product=await axios.delete(`http://54.89.10.176:3000/expense/delete-expense/${id}`,{headers:{"Authorization":token}})
         //console.log(product)
...
document.getElementById('rzpbtn').onclick=async (e)=>{
  ...
  const response=await axios.get('http://54.89.10.176:3000/purchase/gopremiumuser',{headers:{'Authorization':token}})
 ...
 // console.log(response.data.order.id)
          ...
          var options={
            ...
            "handler":async function(response){
                await axios.post('http://54.89.10.176:3000/purchase/updatepremiumuser',{
...
axios.get('http://54.89.10.176:3000/premium/leaderboard',{headers:{'Authorization':token}}).then(res=>{
...
function expensereport(event){
  ...
  axios.get('http://54.89.10.176:3000/premium/expensereport',{headers:{'Authorization':token}})
  .then((response)=>{
...
//  axios.get('http://54.89.10.176:3000/premium/downloadreport',{headers:{''})
