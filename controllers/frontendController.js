...
exports.resetPassword=(req,res,next)=>{
    ...
    transEmailApi.sendTransacEmail({
        ...
        textContent:`<a href='http://54.89.10.176:3000/password/resetpassword/{{params.id}}'>click here to reset your password</a>
        http://54.89.10.176:3000/password/resetpassword/{{params.id}}`,
        params:{
            id:reqkey.id
        }
    })
